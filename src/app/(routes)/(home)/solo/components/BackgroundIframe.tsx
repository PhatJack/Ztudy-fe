  ...
  return (
    <div>
      <iframe
        ...
        allowFullScreen
        className="aspect-video min-w-full w-screen min-h-full box-border h-[56.25vw] pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
      ></iframe>
    </div>
  );
}
