...
const QuoteDisplay = () => {
  ...
  return state.isDisplayQuote ? (
    <div className="absolute top-3/4 right-0 md:top-[40%] -z-10 md:right-10 text-center w-full md:w-[500px] md:text-right flex flex-col gap-1 text-white pointer-events-none select-none">
      <p
